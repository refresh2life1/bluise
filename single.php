      ...
      <div class=" <?php print esc_html($wpestate_options['content_class']);?> single_width_blog">
          ...
          <div class="single-content single-blog">
              ...
              <div class="prop_social_single">
                  ...
                  <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode(get_the_title() .' '.  esc_url(get_permalink())); ?>" class="share_tweet" target="_blank" rel="noreferrer"  ><i class="fab fa-twitter"></i></a>
                  ...
                  <?php } ?>
                      <a href="https://api.whatsapp.com/send?text=<?php echo urlencode(get_the_title().' '. esc_url(get_permalink())); ?>" class="" rel="noreferrer" ><i class="fab fa-whatsapp" aria-hidden="true"></i></a>
